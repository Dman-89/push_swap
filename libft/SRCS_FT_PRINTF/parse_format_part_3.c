...
/*   Updated: 2019/03/04 15:49:08 by bsprigga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	apply_colors(char *format, int j, int ord)
{
	...
	substr = ft_strsub(format, 0, j + 1);
	if (ft_strstr(substr, "{red}") ||
	ft_strstr(substr, "{green}") ||
	ft_strstr(substr, "{yellow}") ||
	ft_strstr(substr, "{blue}") ||
	ft_strstr(substr, "{magenta}") ||
	ft_strstr(substr, "{black}") ||
	ft_strstr(substr, "{cyan}") ||
	ft_strstr(substr, "{gray}") ||
	ft_strstr(substr, "{def}"))
	{
...
static int	apply_bg_colors(char *format, int j, int ord)
{
	...
	substr = ft_strsub(format, 0, j + 1);
	if (ft_strstr(substr, "{BG_RED}") ||
	ft_strstr(substr, "{BG_BLACK}") ||
	ft_strstr(substr, "{BG_GREEN}") ||
	ft_strstr(substr, "{BG_BROWN}") ||
	ft_strstr(substr, "{BG_BLUE}") ||
	ft_strstr(substr, "{BG_MAGENTA}") ||
	ft_strstr(substr, "{BG_CYAN}") ||
	ft_strstr(substr, "{BG_GRAY}") ||
	ft_strstr(substr, "{BG_DEF}"))
	{
